...
const aboutCardData = [
  {
    ...
    image: Jordan,
    name: "Jordan",
    headerText: "Hard Work",
    paragraphText: `Hard work is embedded in Mindkeyz's dna. We have build our platform from scratch facing many challenges and struggles.`,
  },
  {
    index: 1,
    image: Diego,
    ...
    paragraphText:
      "If you wanna make it big in any profession, having persistence will carry you through when the going gets though. ",
  },
  {
    index: 2,
    image: Maschine,
    ...
    paragraphText:
      "We fully utilize our creativity, whether making beats, creating artworks, designing websites or building our business.",
  },
  {
    index: 3,
    image: Keyboards,
